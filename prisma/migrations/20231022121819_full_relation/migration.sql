/*
  ...
  - You are about to drop the column `isPasswordSet` on the `doctors` table. All the data in the column will be lost.
  - You are about to drop the column `phoneNumebr` on the `doctors` table. All the data in the column will be lost.
  - You are about to drop the column `specializationId` on the `doctors` table. All the data in the column will be lost.
  - You are about to drop the column `updatedAt` on the `doctors` table. All the data in the column will be lost.
  - You are about to drop the column `createdAt` on the `specializations` table. All the data in the column will be lost.
...
-- DropIndex
DROP INDEX "doctors_phoneNumebr_key";

-- AlterTable
ALTER TABLE "doctors" DROP COLUMN "createdAt",
DROP COLUMN "isPasswordSet",
DROP COLUMN "phoneNumebr",
DROP COLUMN "specializationId",
DROP COLUMN "updatedAt",
ADD COLUMN     "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "is_password_reset" BOOLEAN NOT NULL DEFAULT false,
...
-- AlterTable
ALTER TABLE "specializations" DROP COLUMN "createdAt",
DROP COLUMN "updatedAt",
ADD COLUMN     "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updated_at" TIMESTAMP(3) NOT NULL;
